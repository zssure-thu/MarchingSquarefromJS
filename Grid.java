 ...
 *
 * <p>
 * Every 2x2 block of pixels in the binary image forms a contouring cell, so the
 * whole image is represented by a grid of such cells (shown in green in the
...
class Grid {
	...
	public String toString() {
		if (str == null) {
			str = new StringBuilder("Grid{rowCount=").append(rowCount).append(", colCount=").append(colCount)
					.append(", threshold=").append(threshold).append('}').toString();
		}
		return str;
	}
